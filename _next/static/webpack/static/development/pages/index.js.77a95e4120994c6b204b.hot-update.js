...
var nombre = Bitcoin;
var ordenar = date;
var token = NPY7MA4BL6ZJU6TOIDST;
...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var APINewsURL, eventAPI, precio, noticias, resPrecio, resNoticias;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          eventAPI = "https://www.eventbriteapi.com/v3/events/search/?q=".concat(nombre, "&categories=").concat(categoria, "&sort_by=").concat(ordenar, "&token=").concat(token, "&locale=es_ES");
          _context.next = 4;
...
//# sourceMappingURL=index.js.77a95e4120994c6b204b.hot-update.js.map