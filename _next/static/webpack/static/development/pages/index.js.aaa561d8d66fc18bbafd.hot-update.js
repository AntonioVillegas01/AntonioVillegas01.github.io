...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var ciudad, categoria, ordenar, token, APINewsURL, eventAPI, precio, noticias, resPrecio, resNoticias;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          eventAPI = "https://www.eventbriteapi.com/v3/events/search/?q=".concat(_this.nombre, "&categories=").concat(_this.categoria, "&sort_by=").concat(_this.ordenar, "&token=").concat(_this.token, "&locale=es_ES");
          _context.next = 8;
...
//# sourceMappingURL=index.js.aaa561d8d66fc18bbafd.hot-update.js.map