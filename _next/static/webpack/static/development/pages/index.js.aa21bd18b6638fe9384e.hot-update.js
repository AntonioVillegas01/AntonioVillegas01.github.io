    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          eventAPI = "https://www.eventbriteapi.com/v3/events/search/?q=".concat(_this.nombre, "&categories=").concat(categoria, "&sort_by=").concat(_this.ordenar, "&token=").concat(_this.token, "&locale=es_ES");
          _context.next = 7;
...
//# sourceMappingURL=index.js.aa21bd18b6638fe9384e.hot-update.js.map