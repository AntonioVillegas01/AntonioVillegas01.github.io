...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var ciudad, categoria, ordenar, APINewsURL, eventAPI, precio, noticias, resPrecio, resNoticias;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          eventAPI = "https://www.eventbriteapi.com/v3/events/search/?q=".concat(busqueda.nombre, "&categories=").concat(busqueda.categoria, "&sort_by=").concat(_this.ordenar, "&token=").concat(_this.token, "&locale=es_ES");
          _context.next = 7;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('https://api.coinmarketcap.com/v2/ticker/1/?CMC_PRO_API_KEY=fe231f8e-6d40-49c8-a22b-231123a7543a');
...
//# sourceMappingURL=index.js.0ba19d0c20db3c0d51cf.hot-update.js.map